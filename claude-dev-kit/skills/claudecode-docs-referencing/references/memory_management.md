...
コンビニには**全店共通のマニュアル**があります。「いらっしゃいませ」と挨拶する、レジでは両手でお金を受け取る、といった基本動作。どの店舗でも、どのシフトでも必ず守るルールです。

CLAUDE.md には、この「全店共通マニュアル」を書きます：

| 項目 | コンビニのマニュアル | CLAUDE.mdに書くこと |
|------|-------------------|------------------|
| **目的** | 「お客様に快適な買い物体験を提供」 | プロダクトの目的 |
| **前提** | 「24時間営業」「セルフサービス」 | 使用技術 |
| **構成** | 「レジ、ホットスナック、ドリンク棚などの売り場」 | ディレクトリ構成 |
| **設定** | 「商品には棚番号・価格・消費期限がある」 | データ構造・命名規則 |
| **仲間** | 「本部サポートセンターに電話できる」 | 利用可能なサブエージェント |
| **スタイル** | 「笑顔で丁寧な接客」 | コーディングスタイル |

ホットスナック担当でも、レジ担当でも、「いらっしゃいませ」の挨拶は変わりません。**特定の売り場だけでなく、店舗全体を通じて常に適用される基本ルール**を CLAUDE.md に書くのです。
