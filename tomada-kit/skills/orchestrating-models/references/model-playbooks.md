...
- **思考ではなく根拠を求める**: 「思考過程を書き出せ / 説明せよ」ではなく、file:line、コマンド出力、成果物そのものを求める。思考過程の書き出しは `reasoning_extraction` 拒否を踏みうる。
- **「よく考えて」を書かない**: 思考は常時オンで、量は effort が決める。深く考えさせたい作業は architect(high)に渡す。
